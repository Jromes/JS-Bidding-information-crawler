# -*- coding: utf-8 -*-
"""
Created on Fri Jul 17 17:08:22 2020
...
# =============================================================================
        ...
        jifw_price = re.findall(r'万元（工程计费额按<span>(.+?)</span>', drivepagesource_chd_2)
        shuju.append(gusuan_price[0])
        shuju.append(jifw_price[0])
        result_list.append(shuju)
        suoyou = driver.window_handles
...
#         result.write(str(result_list[m][3]))
#         result.write('\t')
#         result.write(str(result_list[m][5]))
#         result.write('\n')
# result.close()
# =============================================================================
